...
type Model struct {
	...
	// Horizontal step represents the step of indent we add left or right.
	HorizontalStep int
	// indent represents the indentation: number of runes from the first rune of line.
	indent      int
	initialized bool
	lines       []string
}
